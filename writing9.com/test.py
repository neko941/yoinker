...
class Writing9Scraper():
    ...
    def get_repeated_words(self):
        try:
            num_rws = self.soup.find(name='div', class_='jsx-3229629309 highlight-legends__item highlight-legends__item_repeatedwords').find(name='span', class_='jsx-3229629309 highlight-legends__item-counter').get_text()
    ...
    def get_all_info(self, save_dir):
            ...
            if self.response.status_code == 200:
                ...
                try:
                    ...
                    self.get_text_stats()
                    self.get_scores()   
                    print(self.num_paragraphs, self.num_words)
                    data = {
                        'url' : self.url,
                        'file' : save_dir,
                        'topics' : self.topics,
...
url = f'https://writing9.com/text/5dbc3c64ed6fd80018106a9d'
print(Writing9Scraper(url).get_all_info(save_dir='1.json'))
